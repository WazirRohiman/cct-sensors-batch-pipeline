.PHONY: help setup lint test data-dirs airflow-up airflow-down airflow-reset

help:
	@echo "Targets: setup | lint | test | data-dirs | airflow-up | airflow-down | airflow-reset"
